      ...
      description: (
        <>
          <section className="section">
            ...
            <p>
              In this app, you can add, delete and edit tasks. You can also
              search for tasks.
            </p>
            <p>
          ...
          <section className="section">
            ...
            <p>
              This project was originally based off a really great tutorial by{" "}
              <a href="https://ibaslogic.com/" target="_blank" rel="noopener">
                ibaslogic.
              </a>
            </p>
            ...
            <ul>
              <li>
                Rewrote adding todo to be visible only when you click a button
                "Add Task".
              </li>
              <li>
    ...
    },
    {
      ...
      description: (
        <div className="section">
          <p>
            I'm Zara and I love learning. Check out some more projects on{" "}
            <a
              href="https://github.com/zarasyversen"
              target="_blank"
              rel="noopener"
            >
              my Github
            ...
            or{" "}
            <a
              href="https://twitter.com/madebyzara"
              target="_blank"
              rel="noopener"
            >
